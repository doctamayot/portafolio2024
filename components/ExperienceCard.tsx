...
export default function ExperienceCard({ exp }: { exp: Experience }) {
  ...
  return (
    <article className="flex flex-col rounded-l space-y-7 mt-24 flex-shrink-0 md:items-center w-[300px] md:w-[700px] md:justify-center md:snap-center p-10 bg-[#292929] hover:opacity-100  transition-opacity duration-200 overflow-hidden">
      {info?.companyImage && (
        <motion.img
